-- DeltaForge INSERT perf test: 5M-row x 43-col dim_customer shape, written
...
DROP DELTA TABLE IF EXISTS pbi.bench.dim_customer_insert WITH FILES;

CREATE DELTA TABLE pbi.bench.dim_customer_insert (
...
LOCATION 'B:/odbc_df/df-demo/perf_test/dim_customer_insert';

INSERT INTO pbi.bench.dim_customer_insert
SELECT
    g.customer_id,
    g.customer_code,
    g.salutation,
